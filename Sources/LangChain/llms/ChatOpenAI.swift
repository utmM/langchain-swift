...
public class ChatOpenAI: LLM {
    ...
    public init(httpClient: HTTPClient? = nil, urlSession: URLSession? = nil, temperature: Double = 0.0, model: ModelID = Model.GPT4.gpt4o_mini, callbacks: [BaseCallbackHandler] = [], cache: BaseCache? = nil) {
